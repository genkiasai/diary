<?php
    ...
    if (!isset($_POST["tab"]) && !isset($_POST["send"])) {
        ...
        $_POST["diary_data"]["get_up_time_h"] = "";
        $_POST["diary_data"]["get_up_time_m"] = "";
        $_POST["diary_data"]["dinner_time_h"] = "";
        $_POST["diary_data"]["dinner_time_m"] = "";
        $_POST["diary_data"]["bath_time_h"] = "";
        $_POST["diary_data"]["bath_time_m"] = "";
        $_POST["diary_data"]["going_to_bed_time_h"] = "";
        $_POST["diary_data"]["going_to_bed_time_m"] = "";
        $_POST["diary_data"]["nap_time_h"] = "";
        $_POST["diary_data"]["nap_time_m"] = "";
        $_POST["diary_data"]["last_screen_time_h"] = "";
        $_POST["diary_data"]["last_screen_time_m"] = "";
        // 気温は入力なしの値
        $temp = "999";
